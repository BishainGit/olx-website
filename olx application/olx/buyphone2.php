   ...
   if($conn->connect_error){
      ...
      $sql2 = "select id from user where userid = '$userid' ";
	   ...
	   $row=mysqli_fetch_array($buyerid,MYSQLI_NUM);  
	     ...
	     $sql5 = "select productid from phone where phoneid = '$phoneid' ";
	  ...
	  $sql7 = "select sellerid from sells a inner join phone b on a.sellid = b.sellid where b.phoneid = '$phoneid' ";
	   $id = $conn->query($sql7);
